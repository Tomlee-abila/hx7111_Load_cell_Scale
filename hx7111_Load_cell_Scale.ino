...
#include <Wire.h>
#include <LiquidCrystal_I2C.h> // need to install the link for zip file https://downloads.arduino.cc/libraries/github.com/marcoschwartz/LiquidCrystal_I2C-1.1.2.zip
...
int buzzer = 11; //connect buzzer positive to pin 11 and ground to GND
int led = 5; //connect led positive to pin 5 and ground to GND
void setup() 
{
  pinMode(led, OUTPUT);
